 ...
 * @Version: 2.0
 * @Autor: llxs
 * @Date: 2021-10-19 09:19:50
 * @LastEditors: llxs
 * @LastEditTime: 2021-10-19 18:15:15
 */
...
module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        const cats = await Category.find().lean()/* .where({ parent: parent }) */
    ...
    //   return { categoryName:li.innerText,
